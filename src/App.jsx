...
function App() {
  ...
  const renderNav = () => {
    if (
      curLocation.pathname != "/admin" &&
      curLocation.pathname != "/admin-signup"
    ) {
      return <Nevbar />;
    }
  };
    ...
    <div class="bg-web">
      <AuthProvider className="App">
        ...
        <Routes>
          ...
          <Route
            path="/select-graphics-position"
            element={<SelectGraphicsPositionPage />}
          />
          <Route path="/select-position" element={<SelectPositionPage />} />
          <Route
            path="/select-graphics-position/:id/:position"
            element={<SelectGraphicsPositionPage />}
          />
