          ...
          <div className="box">
              ...
              <div class="box4">
                ...
                <div class="card-container-box4">
                  ...
                  <div class="box4-card4">
                    <img src={iconsocial} alt="icon" class="icon" />
                    <h5>
                      ค่าเฉลี่ยการเข้าอินเทอร์เน็ตผ่านคอมพิวเตอร์จากทั่วโลก
                    </h5>
                  ...
                  <div class="box4-card5">
                    ...
                    <p>
                      คนประเทศไทยเข้า Google มากที่สุดเป็นอันดับ 1
                      ของเว็บทั้งหมด
                    </p>
                    <Link to="#">
                      <button
                  ...
                  <div class="box4-card6">
                    ...
                    <p>
                      เวลาที่ออนไลน์ทั้งหมดเกือบ 2 ใน 3
                      นั้นเข้าผ่านมือถือเป็นหลัก
                    </p>
                    <Link to="#">
                      <button
                        type="button"
            ...
            <div class="full-size5">
              <div class="box5">
                ...
                <p>
                  เว็บไซต์ที่ Anapos นำมานั้นส่วนใหญ่จะมาจากสถิติของ WE ARE
                  SOCIAL โดยจะนำเว็บไซต์ที่คนไทยนั้นเข้าชมมากที่สุดในปี 2022
                ...
                <p class="name-brand-box5">
                  YOUTUBE VIU TRUEID THAIRATH DAILYNEWS SANOOK BANANAIT ADVICE
                  JIB
                </p>
              </div>
            </div>
            ...
            <div class="full-size6">
              <div class="box6">
                <p class="text-head-box6">ประเภทของเว็บไซต์</p>
