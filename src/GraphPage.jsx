          ...
          <div className="graphPage">
            ...
            <div class="box-bt-gp">
              ...
              <div class="text-bt-gp">
                ...
                <p>
                  แสดงผลของข้อมูลแต่ละประเภทโดยรายละเอียด แบ่งตามแต่ละประเภทต่างๆ
                </p>
              </div>
            </div>
            ...
            <div class="box-bt-gp">
              ...
              <div class="text-bt-gp">
                <h5>เพศ</h5>
                <p>
                  แสดงข้อมูลการเลือกจากผู้ใช้โดยจะแบ่งเป็นแต่ละเพศที่เข้าไปเลือกเว็บไซต์ต่างๆ
                </p>
              </div>
            </div>
            {/* <select
