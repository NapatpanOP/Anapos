...
function SugPage() {
  ...
  //   setAddStatus("เสร็จสิ้น");
  // };

  const addSuggestion = async () => {
    if (!websiteName || !websiteType || !websiteUrl) {
      // ถ้าข้อมูลไม่ครบถ้วน ไม่ส่งข้อมูล
      setAddStatus(<span className="error-message">กรุณากรอกข้อมูลให้ครบถ้วน</span>);
      return;
    }
