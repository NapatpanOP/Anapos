  ...
  return (
    <div>
      ...
      <div class="box1-text-type">
        ...
        <p>
          เว็บไซต์ที่ Anapos
          นำมานั้นส่วนใหญ่จะมาจากเว็บไซต์คนไทยเข้าชมมากที่สุดในปี 2021
          แล้วมาแบ่งเป็นประเภทต่างๆ โดยแบ่งได้ 3 ประเภทด้วยกัน ได้แก่ บันเทิง
          ข่าวสาร และธุรกิจ
          สามารถเลือกเว็บไซต์ที่สนใจหรือใช้บ่อยและกดเลือกตำแหน่งของโฆษณาที่ชื่นชอบได้เลย
        </p>
        <p class="head-box-type">สามารถเลือกทำได้มากกว่า 1 เว็บไซต์</p>
      </div>
